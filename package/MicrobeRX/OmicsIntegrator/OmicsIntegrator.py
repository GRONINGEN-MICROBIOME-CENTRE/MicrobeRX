...
from package.MicrobeRX.DataBase.DataFiles import load_microbes_data, load_microbes_reactions
...
def check_if_microbes_databases_are_loaded():
    if 'MICROBES_DATA' not in globals():
        MICROBES_DATA=load_microbes_data()

    if 'MICROBES_REACTIONS' not in globals():
